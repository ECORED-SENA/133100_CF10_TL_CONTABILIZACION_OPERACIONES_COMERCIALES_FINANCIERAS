...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.overflow-hidden
    ...
    p.mb-5 Dentro del manual de políticas contables se deben establecer los lineamientos para la medición, reconocimiento, presentación y revelación de las cuentas comerciales por pagar a proveedores como un instrumento financiero.
      ...
      .col-lg-7
        ...
        .tarjeta.bg-color-3.p-4(data-aos="fade-left").mb-4
          .row.align-items-start
            ...
            .col-lg
              p.mb-0 La entidad revelará, en el resumen de las políticas contables, la base de medición utilizada para instrumentos financieros de cuentas comerciales por pagar a proveedores, que sean relevantes para la comprensión de los estados financieros.
    ...
    .bg-full-width.bg-fondo-5
      .px-4.px-md-5
        ...
        #t_2_2.titulo-segundo.color-acento-contenido.mb-5(data-aos="flip-up")
          h2 2.2 Medición y reconocimiento

        p.mb-5 Al reconocer inicialmente un pasivo financiero, la entidad lo medirá al precio de la transacción, incluyendo los costos de transacción.

        .row.mb-5
          .col-lg-4
            figure
              img(src="@/assets/curso/tema2/10.png").mx-auto
          .col-lg-8
            ...
            .row.align-items-center.mb-4
              .col-lg-auto
                img(src="@/assets/curso/tema2/3.svg", style="max-width: 90px").mx-auto
              .col-lg
                p.mb-0 Un acuerdo constituye una transacción de financiación si el pago se aplaza más allá de los términos comerciales normales, por ejemplo, por la venta de bienes sin interés o a una tasa de interés por debajo del mercado.


            p.mb-4 Si el acuerdo constituye una transacción de financiación, la entidad medirá el activo financiero o pasivo financiero al valor presente de los pagos futuros descontados a una tasa de interés de mercado para un instrumento de deuda similar determinado en el reconocimiento inicial.
        ...
        .row.mb-5
          .col-lg-4
            figure
              img(src="@/assets/curso/tema2/12.svg").mx-auto
          .col-lg-8
            .titulo-sexto.color-acento-contenido.mb-3
              h5 Tabla 19.
              span Registro contable por adquisición de inventario con retenciones y pago parcial a proveedores
        ...
        #t_2_3.titulo-segundo.color-acento-contenido.mb-5(data-aos="flip-up")
          h2 2.3 Presentación y revelación
